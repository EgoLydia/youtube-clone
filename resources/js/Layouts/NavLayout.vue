...
<template>
    <div class="relative">
        <div id="TopNav" class="w-[100%] h-[60px] fixed bg-black z-20 flex items-center justify-between">
            ...
            <div>
                <img class="rounded-full mx-8" width="35"
                    src="https://lh3.googleusercontent.com/ogw/AAEL6sh60T2fgRqTxwzEWIDZ9S8r-0QrKwLDi-f_WXVB=s32-c-mo">
            </div>
        </div>
        ...
        <div v-if="width > 639">
            <div v-if="$page.url === '/'" id="SideNav" :class="[
        ...
        <div @click="openSideNavOverlay = false" class="bg-black bg-opacity-70 fixed z-50 w-full h-screen" :class="
            openSideNavOverlay
                ...
                : 'hidden z-[-1]'
        " />
        <div id="SideNavOverlay" ref="sideNavOverlay" class="h-[100%] fixed z-50 bg-black mt-[9px] w-[240px]" :class="
            openSideNavOverlay
